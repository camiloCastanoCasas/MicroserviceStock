...
public class BrandRestController {
    ...
    @Operation(summary = "Create brand",
            tags = { "Brand"},
            description = "This operation allows the creation of a new brand in the system. "
                    + "The brand must have a unique name, and the name and description "
                    + "fields must comply with validation rules such as not being empty and "
                    + "not exceeding the maximum length. If the brand is successfully created, "
    ...
    @Operation(summary = "Brand Pagination",
            tags = { "Brand", "Pagination" },
            description = "This operation retrieves a paginated list of available brands in the system. Clients can specify the desired page number and page size, as well as sort the brands in ascending or descending order by their name.")
    @ApiResponses(value = {
